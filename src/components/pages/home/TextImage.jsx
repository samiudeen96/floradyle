  ...
  }, 
{
  ...
  <div>
    ...
    <div className='container py-40 '>
                <div className='grid grid-cols-2 mt-20 gap-20'>  
                    ...
                    <p className='mt-8'>Ever notice how your skin gets worse the more products you try? There's a reason. Most brands pile on ingredients, hoping a few might work. Your poor skin is overwhelmed, irritated, and nowhere near its natural best.</p>
                    </div>
                ...
                <div className='grid grid-cols-2 mt-20 gap-20'>  
                    ...
                    <p className='mt-8'>We stripped away everything unnecessary and focused on five ingredients proven to strengthen your skin's natural barrier. The result? Skin that looks better, feels better, and actually gets healthier—not just temporarily masked.</p>
                    </div>
                </div>
    </div>

    
      <div className='container relative mb-50' id="image3Ref">

        <div className='bg-[#D4DCCF] h-[170vh] rounded-2xl  flex flex-col justify-between items-center p-5'>
              <h3 className='pt-30 '><strong>Real result</strong> you <br /> can see and feel.</h3>

             <Image className='absolute top-2/12 z-0 image3'  src="/imageText3.avif" width={700} height={700} alt="" />
  ...
  <div className="flex flex-col gap-5">
    ...
    <div>
      We stripped away everything unnecessary and focused on five ingredients
    </div>
    </div>
    <div className='min-h-72 flex flex-col justify-between h-full p-10 bg-white/25 rounded-lg'>
    <h4>
  ...
  <div className="col-span-2 h-full pt-10 px-10 rounded-lg bg-black/5 flex flex-col justify-between ">
    ...
    <p className='mt-4'>Developed in partnership with dermatological researchers, our formulation philosophy is built on clinical evidence that shows fewer, more concentrated ingredients deliver superior results. Our minimalist approach is validated by extensive testing across diverse skin types and conditions.</p>
    </div>
