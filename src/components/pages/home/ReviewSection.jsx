...
const ReviewSection = () => {
  ...
  return (
    <div ref={containerRef} className='container'>
      ...
      <div className='h-[100vh] flex items-center justify-center first-content relative'>
      ...
      {/* REVIEWS GRID */}
      <div className='section min-h-[100vh] flex items-center justify-center second-content relative z-10'>
      ...
      <div className='min-h-[100vh] flex items-center justify-center third-content opacity-0'>
        
      </div>
      
      <div className='min-h-[100vh] flex items-center justify-center forth-content opacity-0'>
      </div>
    </div>
  );
}
